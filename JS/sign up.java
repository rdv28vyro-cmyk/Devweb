...
class AuthHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        // If authenticated, serve index.html or the requested static file
    ...
    private boolean isValidSession(String cookieHeader) {
        // Simple check to see if our session ID is inside the Cookie string
